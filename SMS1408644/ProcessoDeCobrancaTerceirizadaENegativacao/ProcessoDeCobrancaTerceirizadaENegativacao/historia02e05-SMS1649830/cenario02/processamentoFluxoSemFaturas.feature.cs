...
namespace ProcessoDeCobrancaTerceirizadaENegativacao.Historia02_SMS1649830.Cenario02
{
...
#line 1 "processamentoFluxoSemFaturas.feature"
#line hidden
  ...
  PARA que esta possa realizar o processamento da cobrança e proceder com a negociação da dídiva junto ao responsável financeiro.", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Processar a Rotina Arquivo Cobrança Terceirizada para envio dos documentos à empr" +
            "esa terceirizada com informação de beneficiários sem faturas elegíveis para a ro" +
            "tina")]
        ...
        public virtual void ProcessarARotinaArquivoCobrancaTerceirizadaParaEnvioDosDocumentosAEmpresaTerceirizadaComInformacaoDeBeneficiariosSemFaturasElegiveisParaARotina()
        {
...
#line 14
 testRunner.But("o beneficiário não possui faturas elegíveis \"Abertas\", \"Suspensas\" ou \"Canceladas" +
                    "\" até a data do processamento", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Mas ");
#line 15
    testRunner.When("a rotina for processada", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quando ");
#line 16
    testRunner.Then("não deverá gerar nenhum arquivo contendo documentos para envio à terceirizada", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Então ");
#line hidden
