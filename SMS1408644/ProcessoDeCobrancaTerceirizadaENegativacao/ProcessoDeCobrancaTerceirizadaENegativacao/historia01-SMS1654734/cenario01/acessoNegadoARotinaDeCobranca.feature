...
@VERSAO_3.52
Cenário: Negar acesso ao usuário à rotina de cobrança 
	Dado um usuário que não tenha permissão de acesso a Rotina Arquivo Cobrança Tercerizada
	Quando for acessado o módulo CONTROLE FINANCEIRO
	E acessar a carga de Documentos
	Então não será possível visualizar as informações a respeito da cobrança terceirizada